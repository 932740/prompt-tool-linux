...
async def api_generate(req: GenerateRequest):
    result = await generate_prompt(req.desc, req.scene.value, req.style.value, req.lang.value)
...
async def api_optimize(req: OptimizeRequest):
    ...
    result = await optimize_prompt(req.input, req.goal.value, req.scene, req.lang.value)
